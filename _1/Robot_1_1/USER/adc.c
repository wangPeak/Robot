...
short  ADC_To_Velocity(uint16_t ADC_ConvertedValue)  //电压转换函数   用于将得到的0~3,3V电压数值  线性的对应到MAX_Velocity - MIN_Velocity 之间
{
	return ((((float)MAX_Velocity - (float)MIN_Velocity)/4095.0) * ADC_ConvertedValue) + MIN_Velocity;
}
/*********************************************END OF FILE**********************/
